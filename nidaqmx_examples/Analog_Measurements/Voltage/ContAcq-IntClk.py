...
Example Category:
 ...
 Steps:
   ...
   3. Set the rate for the sample clock. Additionally, define the
      sample mode to be continuos and set the number of samples to be
      acquired per channel.
   4. Call the Start function to start the acquisition.
   5. Read all of the waveform data until the KeyboardInterrupt occurs.
...
phys_channel_name = 'dev1/ai0:7'
range_max = 10
range_min = -10
acquistion_mode = AcquisitionType.CONTINUOUS
terminal = TerminalConfiguration.DIFFERENTIAL
