...
class OutStream(object):
    ...
    def curr_write_pos(self):
        """
        float: Indicates the position in the buffer of the next sample
            to generate. This value is identical for all channels in the
            task.
        """
        val = ctypes.c_double()
    ...
    def total_samp_per_chan_generated(self):
        """
        float: Indicates the total number of samples generated by each
