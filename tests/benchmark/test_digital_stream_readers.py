...
def test___digital_single_channel_reader___read_one_sample_one_line(
    ...
    di_single_line_benchmark_task: nidaqmx.Task,
    num_channels: int,
    num_samples: int,
) -> None:
    reader = DigitalSingleChannelReader(di_single_line_benchmark_task.in_stream)
...
def test___digital_single_channel_reader___read_one_sample_multi_line(
    benchmark: BenchmarkFixture,
    di_multi_line_benchmark_task: nidaqmx.Task,
    num_channels: int,
    num_samples: int,
    num_lines: int,
) -> None:
    reader = DigitalSingleChannelReader(di_multi_line_benchmark_task.in_stream)
...
def test___digital_single_channel_reader___read_waveform_single_line(
    benchmark: BenchmarkFixture,
    di_single_line_benchmark_task: nidaqmx.Task,
    num_channels: int,
    num_samples: int,
    ...
    reader = DigitalSingleChannelReader(di_single_line_benchmark_task.in_stream)
    waveform = DigitalWaveform(num_samples, signal_count=1)
...
def test___digital_multi_channel_reader___read_one_sample_one_line(
    ...
    reader = DigitalMultiChannelReader(di_single_line_benchmark_task.in_stream)
...
def test___digital_multi_channel_reader___read_one_sample_multi_line(
    ...
    reader = DigitalMultiChannelReader(di_multi_line_benchmark_task.in_stream)
...
@pytest.mark.parametrize("num_samples", [1, 100])
@pytest.mark.grpc_skip(reason="read_digital_waveform not implemented in GRPC")
def test___digital_multi_channel_reader___read_waveform_single_line(
    benchmark: BenchmarkFixture,
    di_single_line_benchmark_task: nidaqmx.Task,
    num_channels: int,
    num_samples: int,
    ...
    reader = DigitalMultiChannelReader(di_single_line_benchmark_task.in_stream)
    waveforms = [DigitalWaveform(num_samples, signal_count=1) for _ in range(num_channels)]
