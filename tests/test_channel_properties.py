"""Contains a collection of pytest tests for validating channel properties for different basic data types."""
...
def test__channel__get_float_property__returns_value(ai_rtd_chan: AIChannel):
    ...
    # Default 'A' constant of the Callendar-Van Dusen equation in the NI PCIe-6363 device is "0.00381"
...
def test__channel__get_string_property__returns_value(ci_pulse_width_chan: CIChannel):
    ...
    # Default timebase value of the pulse width filter in the NI PCIe-6363 device is "100MHzTimebase"
