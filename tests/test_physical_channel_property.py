...
def test__physical_channel__get_bit_stream__returns_assigned_value(
    any_x_series_device, test_assets_directory
):
...
def test__physical_channel__get_string_property__returns_assigned_value(
    any_x_series_device, test_assets_directory
):
...
def test__physical_channel__get_uint32_array_property__returns_assigned_value(
    any_x_series_device, test_assets_directory
):
...
def test__physical_channel__get_uint32_property__returns_assigned_value(
    any_x_series_device, test_assets_directory
):
