...
@pytest.mark.grpc_skip(reason="write_digital_waveform not implemented in GRPC")
def test___task___write_digital_waveform___output_matches_final_value(
    do_single_line_task: nidaqmx.Task,
...
@pytest.mark.grpc_skip(reason="write_digital_waveform not implemented in GRPC")
def test___task___write_waveform_multi_line___output_matches_final_value(
...
@pytest.mark.grpc_skip(reason="write_digital_waveform not implemented in GRPC")
def test___task___write_waveform_multi_line_with_non_contiguous_data___output_matches_final_value(
    do_single_channel_multi_line_task: nidaqmx.Task,
    di_multi_line_loopback_task: nidaqmx.Task,
) -> None:
    num_samples = 20
...
@pytest.mark.grpc_skip(reason="write_digital_waveform not implemented in GRPC")
def test___task___write_waveform_signal_count_mismatch___raises_daq_error(
    do_single_line_task: nidaqmx.Task,
) -> None:
    num_samples = 20
    num_lines = 3
...
@pytest.mark.grpc_skip(reason="write_digital_waveform not implemented in GRPC")
def test___task___write_waveform_8bit_port___output_matches_final_value(
...
@pytest.mark.grpc_skip(reason="write_digital_waveform not implemented in GRPC")
def test___task___write_waveform_32bit_port___output_matches_final_value(
