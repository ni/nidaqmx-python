...
def test___persisted_scales_with_same_name___compare___equal(generate_persisted_scale):
    persisted_scale1 = generate_persisted_scale("Scale1")
    persisted_scale2 = generate_persisted_scale("Scale1")

    assert persisted_scale1 is not persisted_scale2
    assert persisted_scale1 == persisted_scale2


def test___persisted_scales_with_different_names___compare___not_equal(generate_persisted_scale):
    persisted_scale1 = generate_persisted_scale("Scale1")
    persisted_scale2 = generate_persisted_scale("Scale2")
