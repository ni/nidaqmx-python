...
class BaseInterpreter(abc.ABC):
    ...
    def add_network_device(
            self, ip_address, device_name, attempt_reservation, timeout) -> str:
        raise NotImplementedError
    ...
    @staticmethod
    @abc.abstractmethod
    def create_task(self, session_name, initialization_behavior):
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def get_arm_start_trig_timestamp_val(self, task):
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def get_cal_info_attribute_bool(self, device_name, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_cal_info_attribute_double(self, device_name, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_cal_info_attribute_string(self, device_name, attribute) -> str:
        raise NotImplementedError

    @abc.abstractmethod
    def get_cal_info_attribute_uint32(self, device_name, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_chan_attribute_bool(self, task, channel, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_chan_attribute_double(self, task, channel, attribute, size):
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def get_chan_attribute_int32(self, task, channel, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_chan_attribute_string(self, task, channel, attribute) -> str:
        raise NotImplementedError

    @abc.abstractmethod
    def get_chan_attribute_uint32(self, task, channel, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_device_attribute_bool(self, device_name, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_device_attribute_double(self, device_name, attribute, size):
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def get_device_attribute_int32(self, device_name, attribute, size):
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def get_device_attribute_string(self, device_name, attribute) -> str:
        raise NotImplementedError

    @abc.abstractmethod
    def get_device_attribute_uint32(self, device_name, attribute, size):
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def get_error_string(self, error_code) -> str:
        raise NotImplementedError

    @abc.abstractmethod
    def get_exported_signal_attribute_bool(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_exported_signal_attribute_double(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_exported_signal_attribute_int32(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_exported_signal_attribute_string(self, task, attribute) -> str:
        raise NotImplementedError

    @abc.abstractmethod
    def get_exported_signal_attribute_uint32(self, task, attribute, size):
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def get_first_samp_timestamp_val(self, task):
        raise NotImplementedError

    @abc.abstractmethod
    def get_nth_task_channel(self, task, index) -> str:
        raise NotImplementedError

    @abc.abstractmethod
    def get_nth_task_device(self, task, index) -> str:
        raise NotImplementedError

    @abc.abstractmethod
    def get_nth_task_read_channel(self, task, index) -> str:
        raise NotImplementedError

    @abc.abstractmethod
    def get_persisted_chan_attribute_bool(self, channel, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_persisted_chan_attribute_string(self, channel, attribute) -> str:
        raise NotImplementedError

    @abc.abstractmethod
    def get_persisted_scale_attribute_bool(self, scale_name, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_persisted_scale_attribute_string(self, scale_name, attribute) -> str:
        raise NotImplementedError

    @abc.abstractmethod
    def get_persisted_task_attribute_bool(self, task_name, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_persisted_task_attribute_string(self, task_name, attribute) -> str:
        raise NotImplementedError

    @abc.abstractmethod
    def get_physical_chan_attribute_bool(
            self, physical_channel, attribute, size):
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def get_physical_chan_attribute_string(self, physical_channel, attribute) -> str:
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def get_read_attribute_bool(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_read_attribute_double(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_read_attribute_int32(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_read_attribute_string(self, task, attribute) -> str:
        raise NotImplementedError

    @abc.abstractmethod
    def get_read_attribute_uint32(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_read_attribute_uint64(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_real_time_attribute_bool(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_real_time_attribute_int32(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_real_time_attribute_uint32(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_ref_trig_timestamp_val(self, task):
        raise NotImplementedError

    @abc.abstractmethod
    def get_scale_attribute_double(self, scale_name, attribute, size):
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def get_scale_attribute_int32(self, scale_name, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_scale_attribute_string(self, scale_name, attribute) -> str:
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def get_start_trig_timestamp_val(self, task):
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def get_system_info_attribute_string(self, attribute) -> str:
        raise NotImplementedError

    @abc.abstractmethod
    def get_system_info_attribute_uint32(self, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_task_attribute_bool(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_task_attribute_string(self, task, attribute) -> str:
        raise NotImplementedError

    @abc.abstractmethod
    def get_task_attribute_uint32(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_timing_attribute_bool(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_timing_attribute_double(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_timing_attribute_ex_bool(
            self, task, device_names, attribute, size):
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def get_timing_attribute_ex_string(self, task, device_names, attribute) -> str:
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def get_timing_attribute_int32(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_timing_attribute_string(self, task, attribute) -> str:
        raise NotImplementedError

    @abc.abstractmethod
    def get_timing_attribute_timestamp(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_timing_attribute_uint32(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_timing_attribute_uint64(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_trig_attribute_bool(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_trig_attribute_double(self, task, attribute, size):
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def get_trig_attribute_int32(self, task, attribute, size):
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def get_trig_attribute_string(self, task, attribute) -> str:
        raise NotImplementedError

    @abc.abstractmethod
    def get_trig_attribute_timestamp(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_trig_attribute_uint32(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_watchdog_attribute_bool(self, task, lines, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_watchdog_attribute_double(self, task, lines, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_watchdog_attribute_int32(self, task, lines, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_watchdog_attribute_string(self, task, lines, attribute) -> str:
        raise NotImplementedError

    @abc.abstractmethod
    def get_write_attribute_bool(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_write_attribute_double(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_write_attribute_int32(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_write_attribute_string(self, task, attribute) -> str:
        raise NotImplementedError

    @abc.abstractmethod
    def get_write_attribute_uint32(self, task, attribute, size):
        raise NotImplementedError

    @abc.abstractmethod
    def get_write_attribute_uint64(self, task, attribute, size):
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def load_task(self, session_name, initialization_behavior):
        raise NotImplementedError

    @abc.abstractmethod
    def read_analog_f64(
            self, task, num_samps_per_chan, timeout, fill_mode,
            array_size_in_samps, reserved):
        raise NotImplementedError

    @abc.abstractmethod
    def read_analog_scalar_f64(self, task, timeout, reserved):
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def read_counter_scalar_f64(self, task, timeout, reserved):
        raise NotImplementedError

    @abc.abstractmethod
    def read_counter_scalar_u32(self, task, timeout, reserved):
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def read_ctr_freq_scalar(self, task, timeout, reserved):
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def read_ctr_ticks_scalar(self, task, timeout, reserved):
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def read_ctr_time_scalar(self, task, timeout, reserved):
        raise NotImplementedError

    @abc.abstractmethod
    def read_digital_lines(
            self, task, num_samps_per_chan, timeout, fill_mode,
            array_size_in_bytes, reserved):
        raise NotImplementedError

    @abc.abstractmethod
    def read_digital_scalar_u32(self, task, timeout, reserved):
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def read_power_scalar_f64(self, task, timeout, reserved):
        raise NotImplementedError

    @abc.abstractmethod
    def read_raw(
            self, task, num_samps_per_chan, timeout, array_size_in_bytes,
            reserved):
        raise NotImplementedError
