...
class GrpcStubInterpreter(BaseInterpreter):
    ...
    def add_network_device(
        ...
        response = self._invoke(
            ...
            attempt_reservation=attempt_reservation, device_name=device_name,
            ip_address=ip_address, timeout=timeout))
    ...
    def calculate_reverse_poly_coeff(
        ...
        response = self._invoke(
            ...
            min_val_x=min_val_x, num_forward_coeffs_in=num_forward_coeffs_in,
    ...
    def cfg_anlg_edge_start_trig(
        ...
        response = self._invoke(
            ...
            trigger_slope_raw=trigger_slope, trigger_source=trigger_source))
    ...
    def cfg_burst_handshaking_timing_import_clock(
        ...
        response = self._invoke(
            ...
            sample_clk_rate=sample_clk_rate, sample_clk_src=sample_clk_src,
    ...
    def cfg_change_detection_timing(
        ...
        response = self._invoke(
            ...
            rising_edge_chan=rising_edge_chan, sample_mode_raw=sample_mode,
            samps_per_chan=samps_per_chan, task=task))
    ...
    def cfg_dig_pattern_ref_trig(
        ...
        response = self._invoke(
            ...
            pretrigger_samples=pretrigger_samples, task=task,
            trigger_pattern=trigger_pattern, trigger_source=trigger_source,
    ...
    def configure_logging(
        ...
        response = self._invoke(
            ...
            logging_mode_raw=logging_mode, operation_raw=operation, task=task))
    ...
    def create_ai_current_chan(
        ...
        response = self._invoke(
            ...
            ext_shunt_resistor_val=ext_shunt_resistor_val, max_val=max_val,
            min_val=min_val,
            name_to_assign_to_channel=name_to_assign_to_channel,
    ...
    def create_ai_force_bridge_polynomial_chan(
        ...
        response = self._invoke(
            ...
            forward_coeffs=forward_coeffs, max_val=max_val, min_val=min_val,
            name_to_assign_to_channel=name_to_assign_to_channel,
            nominal_bridge_resistance=nominal_bridge_resistance,
            num_forward_coeffs=num_forward_coeffs,
            num_reverse_coeffs=num_reverse_coeffs,
            physical_channel=physical_channel,
            physical_units_raw=physical_units, reverse_coeffs=reverse_coeffs,
    ...
    def create_ai_force_bridge_table_chan(
        ...
        response = self._invoke(
            ...
            custom_scale_name=custom_scale_name,
            electrical_units_raw=electrical_units,
            electrical_vals=electrical_vals, max_val=max_val, min_val=min_val,
            name_to_assign_to_channel=name_to_assign_to_channel,
            nominal_bridge_resistance=nominal_bridge_resistance,
            num_electrical_vals=num_electrical_vals,
            num_physical_vals=num_physical_vals,
            physical_channel=physical_channel,
            physical_units_raw=physical_units, physical_vals=physical_vals,
            task=task, units_raw=units,
            voltage_excit_source_raw=voltage_excit_source,
            voltage_excit_val=voltage_excit_val))
    ...
    def create_ai_force_bridge_two_point_lin_chan(
        ...
        response = self._invoke(
            ...
            units_raw=units, voltage_excit_source_raw=voltage_excit_source,
            voltage_excit_val=voltage_excit_val))
    ...
    def create_ai_power_chan(
        ...
        response = self._invoke(
            ...
            name_to_assign_to_channel=name_to_assign_to_channel,
            output_enable=output_enable, physical_channel=physical_channel,
            task=task, voltage_setpoint=voltage_setpoint))
    ...
    def create_ai_rosette_strain_gage_chan(
        ...
        response = self._invoke(
            ...
            physical_channel=physical_channel, poisson_ratio=poisson_ratio,
            rosette_meas_types=rosette_meas_types,
            rosette_type_raw=rosette_type, strain_config_raw=strain_config,
            task=task, voltage_excit_source_raw=voltage_excit_source,
            voltage_excit_val=voltage_excit_val))
    ...
    def create_ai_strain_gage_chan(
        ...
        response = self._invoke(
            ...
            nominal_gage_resistance=nominal_gage_resistance,
            physical_channel=physical_channel, poisson_ratio=poisson_ratio,
            strain_config_raw=strain_config, task=task, units_raw=units,
            voltage_excit_source_raw=voltage_excit_source,
            voltage_excit_val=voltage_excit_val))
    ...
    def create_airtd_chan(
        ...
        response = self._invoke(
            ...
            resistance_config_raw=resistance_config, rtd_type_raw=rtd_type,
            task=task, units_raw=units))
    ...
    def create_ci_ang_velocity_chan(
        ...
        response = self._invoke(
            ...
            counter=counter, custom_scale_name=custom_scale_name,
            decoding_type_raw=decoding_type, max_val=max_val, min_val=min_val,
            name_to_assign_to_channel=name_to_assign_to_channel,
            pulses_per_rev=pulses_per_rev, task=task, units_raw=units))
    ...
    def create_ci_count_edges_chan(
        ...
        response = self._invoke(
            ...
            name_to_assign_to_channel=name_to_assign_to_channel, task=task))
    ...
    def create_ci_freq_chan(
        ...
        response = self._invoke(
            ...
            meas_method_raw=meas_method, meas_time=meas_time, min_val=min_val,
            name_to_assign_to_channel=name_to_assign_to_channel, task=task,
            units_raw=units))
    ...
    def create_ci_lin_encoder_chan(
        ...
        response = self._invoke(
            ...
            counter=counter, custom_scale_name=custom_scale_name,
            decoding_type_raw=decoding_type, dist_per_pulse=dist_per_pulse,
            initial_pos=initial_pos,
            name_to_assign_to_channel=name_to_assign_to_channel, task=task,
            units_raw=units, zidx_enable=zidx_enable,
    ...
    def create_co_pulse_chan_ticks(
        ...
        response = self._invoke(
            ...
            counter=counter, high_ticks=high_ticks, idle_state_raw=idle_state,
            initial_delay=initial_delay, low_ticks=low_ticks,
            name_to_assign_to_channel=name_to_assign_to_channel,
            source_terminal=source_terminal, task=task))
    ...
    def create_co_pulse_chan_time(
        ...
        response = self._invoke(
            ...
            counter=counter, high_time=high_time, idle_state_raw=idle_state,
    ...
    def create_lin_scale(
        ...
        response = self._invoke(
            ...
            scaled_units=scaled_units, slope=slope, y_intercept=y_intercept))
    ...
    def read_analog_f64(
        ...
        response = self._invoke(
            ...
            fill_mode_raw=fill_mode, num_samps_per_chan=num_samps_per_chan,
            read_array=read_array, task=task, timeout=timeout))
    ...
    def read_power_binary_i16(
        ...
        response = self._invoke(
            ...
            read_array_voltage=read_array_voltage, task=task, timeout=timeout))
    ...
    def register_done_event(
        ...
        response = self._invoke(
            ...
            callback_data=callback_data, callback_function=callback_function,
    ...
    def register_signal_event(
        ...
        response = self._invoke(
            ...
            callback_data=callback_data, callback_function=callback_function,
            options=options, signal_id_raw=signal_id, task=task))
    ...
    def save_task(self, task, save_as, author, options):
        response = self._invoke(
            ...
            author=author, options_raw=options, save_as=save_as, task=task))
    ...
    def set_digital_pull_up_pull_down_states(
        ...
        for index in range(len(channel_names)):
            pull_up_pull_down_states.append(grpc_types.DigitalPowerUpChannelsAndState(channel_names=channel_names[index], state=state[index]))
        response = self._invoke(
    ...
    def wait_for_valid_timestamp(self, task, timestamp_event, timeout):
        response = self._invoke(
            ...
            task=task, timeout=timeout, timestamp_event_raw=timestamp_event))
    ...
    def write_analog_f64(
        ...
        response = self._invoke(
            ...
            num_samps_per_chan=num_samps_per_chan, task=task, timeout=timeout,
    ...
    def write_analog_scalar_f64(self, task, auto_start, timeout, value):
        response = self._invoke(
            ...
            auto_start=auto_start, task=task, timeout=timeout, value=value))
    ...
    def write_ctr_freq_scalar(
        ...
        response = self._invoke(
            ...
            auto_start=auto_start, duty_cycle=duty_cycle, frequency=frequency,
            task=task, timeout=timeout))
    ...
    def write_ctr_ticks_scalar(
        ...
        response = self._invoke(
            ...
            auto_start=auto_start, high_ticks=high_ticks, low_ticks=low_ticks,
            task=task, timeout=timeout))
    ...
    def write_to_teds_from_array(
        ...
        response = self._invoke(
            ...
            array_size=array_size, basic_teds_options_raw=basic_teds_options,
    ...
    def write_to_teds_from_file(
        ...
        response = self._invoke(
            ...
            basic_teds_options_raw=basic_teds_options, file_path=file_path,
            physical_channel=physical_channel))
