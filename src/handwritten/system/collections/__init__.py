...
from nidaqmx.system.collections._physical_channel_collection import PhysicalChannelCollection

__all__ = ['DeviceCollection', 'PersistedChannelCollection', 'PersistedScaleCollection', 'PersistedTaskCollection', 'PhysicalChannelCollection']