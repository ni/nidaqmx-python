<%page args="function"/>\
<%
    from codegen.utilities.interpreter_helpers import get_arguments_type, generate_interpreter_function_call_args, get_output_param_with_ivi_dance_mechanism, get_output_params 
