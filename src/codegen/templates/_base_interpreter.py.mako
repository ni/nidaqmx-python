<%
    from codegen.utilities.interpreter_helpers import get_interpreter_functions,get_input_params,get_interpreter_parameter_signature,get_return_value_for_interpreter_func
...
<%
    ...
    return_type = get_return_value_for_interpreter_func(func)
    %>\
    @abc.abstractmethod
