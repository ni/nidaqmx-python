...
5. Once the necessary changes are done, update the auto-generated code using ``poetry run python -m codegen --dest generated/nidaqmx``. This will ensure that the latest files are present in ``generated`` folder.
6. Write new tests that demonstrate your bug or feature. Ensure that these new tests fail.
7. Make your change.
